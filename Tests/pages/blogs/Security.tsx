        ...
        <div className="flex justify-center items-center bg-[#ddddce] px-4">
          <div className="bg-[#f8f8e0] w-full max-w-4xl p-4 sm:p-6 md:p-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold">
              Systems that are meant to offer protection and security
            </h1>

            <div className="flex flex-col items-center text-sm sm:text-base md:text-lg font-sans pt-6 gap-4">
              <p>These are systems that offer protection and security to user data, information and ensure secured privacy.</p>
              <p>Most applications are not secure, data breaches occur every day and many devices like cellphones, laptops, televisions fall in the trap of being hacked.</p>
              <p>Many users do not realize their devices have been compromised until they lose access to credentials or social media accounts.</p>
              <p>At Ibonnis we are introducing secure systems intelligence (SSI), native intelligence meant to secure user information and privacy.</p>

              <h1 className="pt-4 text-[#3b3b3b] text-lg sm:text-xl font-medium">
                The SSI offers protection in the following ways:
              </h1>
              <ol className="list-decimal list-inside space-y-1 text-left w-full">
                <li>Notifying users of spam messages immediately</li>
                <li>Blocking security threats in real time</li>
                <li>Protecting user credentials</li>
                <li>Notifying users of vulnerabilities</li>
                <li>Performing security checks every 24 hours</li>
              </ol>
              ...
              <div className="w-full h-64 sm:h-80 md:h-[500px] relative mb-5 mt-6">
                ...
                <p className="absolute top-10 sm:top-20 md:top-40 left-6 sm:left-20 md:left-40 text-sm sm:text-base md:text-lg text-[#fbfce1]">
                  {metadata[0]?.name ?? ""}: 
                  <span className="text-xs sm:text-sm md:text-base text-[#f3ff49] tracking-tight"> Systems meant to protect</span>
                </p>
              </div>

              <p className="text-center text-xs sm:text-sm md:text-base text-[#888885]">
                The SSI ensures user privacy is secured and prevents data breaches.
              </p>
              <p className="tracking-tight text-sm sm:text-base md:text-lg">
                The SSI system will be available for desktops, mobiles and other gadgets, allowing users to install it across platforms.
              </p>
              <p className="text-center font-medium text-lg sm:text-xl md:text-2xl tracking-tight text-red-400">
                At Ibonnis we value your security.
              </p>
            </div>
          </div>
        </div>
