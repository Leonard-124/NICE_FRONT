...
//           'Authorization': `Bearer ${import.meta.env.VITE_API_RESEND}` // Replace with your actual Resend API key
//         },
//         body: JSON.stringify({
//           from: 'support@ibonnis.com', // Use your verified domain or resend.dev for testing
...
//   return (
//     <div className="flex justify-between min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
//       <div className="max-w-md mx-auto bg-[#f2f9fd] rounded-xl shadow-lg overflow-hidden w-full">
//         <div className="bg-[#333f57] px-6 py-4">
//           <h2 className="text-3xl font-bold text-white text-center">
//             Submit Your Request <span className='text-red-500 animate-spin tracking-[-1.5px]'>Now</span>
//           </h2>
...
//             className="w-full bg-[#333f57] text-white font-semibold py-3 px-6 rounded-lg hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg"
//           >
//             {isSubmitting ? (
...
//         </div>
//       </div>
//       <div className='m-2 bg-amber-300 w-full min-h-screen'>
//         <div>
//           <img src={learnin} alt="" />
//         </div>
//         <p>We are focussed on discussing how technology can be implemented and used Efficiently.</p>
//         </div>
//     </div>
//   )
// }
