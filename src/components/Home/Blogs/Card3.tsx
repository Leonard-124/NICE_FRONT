...
//         <div className="w-[1000px] h-full text-xl bg-[#f8f6f6]">
//           <div className="flex justify-between">
//             <div className="w-[700px] h-[550px]">
//               <img src="https://cdn.careerfoundry.com/en/wp-content/uploads/2021/01/difference_between_ux_ui.webp" alt="" />
//             </div>
...
//           </p>
//           <p className="v">
//             <span className="text-2xl text-gray-500 font-bold">UX design maps out the end user’s overall experience, or journey, throughout the product</span> It considers things like: 
//           </p>
//           <ul>
//             <li>What end-user problem should this product solve?</li>
//             <li>What features and functions does the user need within the product?</li>
//             <li>How should the product be structured and mapped out? How can we make it as logical and intuitive as possible?</li>
//             <li>How will different content and information be organized throughout the product?</li>
//             <li>How does the user feel while interacting with the product? What’s the overall quality of their experience?</li>
//           </ul>
//           <p className="v">
...
//           </p>
//           <ul>
//             <li>What elements does the user need on each screen or page? (Elements include things like buttons, scrollbars, images, toggles, and navigation menus). </li>
//             <li>
...
//             </li>
//             <li>How do individual screens connect and relate to each other? </li>
//             <li>
//               How can we make the interface visually appealing? What color schemes, imagery, and typography should we use?
//             </li>
//           </ul>
//           <p className="h-[600px]">
//             <img src="https://cdn.careerfoundry.com/en/wp-content/uploads/old-blog-uploads/difference-between-ux-and-ui.jpg" alt=""
...
//           </p>
//           <p>
//             <img src="https://cdn.careerfoundry.com/en/wp-content/uploads/old-blog-uploads/tasks-and-responsibilities-of-ux-vs-ui-designers.jpg" alt="" />
//           </p>
//           <a href="https://careerfoundry.com/en/blog/ux-design/the-difference-between-ux-and-ui-design-a-laymans-guide/">Get Full Story </a>
//         </div>
//         </div>
//       </div>
//       <Footer />
