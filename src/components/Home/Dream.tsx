...
const Dream = () => {
  return (
    <div className="relative w-full h-96 md:h-128 mt-8 shadow-2xl bg-gray-200">
      {/* Background image */}
      <img //720
        src="https://miro.medium.com/v2/resize:fit:700/format:webp/1*2U5qU1qnwUjgjrvR8l3h9w.jpeg"
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
        <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-white drop-shadow-lg">
          Lets develop future technology together together, Be Part of the team
        </p>
